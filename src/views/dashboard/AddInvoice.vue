        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                <div class="box mt-4" v-if="invoice.client">
                    ...
                    <p v-if="invoice.client.address_line_1">{{ invoice.client.address_line_1 }}</p>
                    <p v-if="invoice.client.address_line_2">{{ invoice.client.address_line_2 }}</p>
                    <p v-if="invoice.client.city_name || invoice.client.state_name">{{ invoice.client.city_name }} {{ invoice.client.state_name }}</p>
                    <p v-if="invoice.client.country_name || invoice.client.zip_code">{{ invoice.client.country_name }} {{ invoice.client.zip_code }}</p>
                </div>
